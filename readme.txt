...
Tags: content, module, modular, shortcode, widget, customize, page builder, builder
...
Allows you to create reusable pieces of content that you can place anywhere in your site.

== Description ==

[CPO Content Blocks](http://cpothemes.com/plugin/cpo-content-blocks) is a powerful tool for adding modular content into your site. This plugin lets you create multiple blocks of multimedia content, which you can then add onto specific parts of your WordPress website.
...
**CPO Content Blocks works with any theme, but the plugin closely integrates with the layouts and hooks used in CPOThemes. To get the best results and maximum flexibility, make sure to try out our [free WordPress themes](http://www.cpothemes.com/themes).**
...
5. Make sure to check the **Settings > CPO Content Blocks** page before using it right away!
6. You are now ready to use CPO Content Blocks
...
4. Make sure to check the **Settings > CPO Content Blocks** page before using it right away!
5. You are now ready to use CPO Content Blocks
